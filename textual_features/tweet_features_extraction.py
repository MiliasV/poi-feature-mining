...
def train_lda_models(eng_tweets, nl_tweets, ntopics, passes):
    ...
    corpora.MmCorpus.serialize("/home/bill/Desktop/thesis/code/UDS/textual_features/"
                               "objects/nl_term_matrix_tweets.mm", nl_term_matrix)
...
def get_lda_models(eng_tweets, nl_tweets, ntopics, passes, load, evaluate):
    if load:
        eng_dict = corpora.Dictionary.load("/home/bill/Desktop/thesis/code/UDS/textual_features/"
                                           "objects/en_dict_tweets.pkl")
        nl_dict = corpora.Dictionary.load("/home/bill/Desktop/thesis/code/UDS/textual_features/"
        ...
        lda_nl = models.LdaModel.load("/home/bill/Desktop/thesis/code/UDS/textual_features/"
        ...
        nl_term_matrix = corpora.MmCorpus("/home/bill/Desktop/thesis/code/UDS/textual_features/"
                                          "objects/nl_term_matrix_tweets.mm")
    else:
        # Train the LDA model
        lda_eng, lda_nl, eng_dict, nl_dict, eng_term_matrix, nl_term_matrix = train_lda_models(eng_tweets, nl_tweets, ntopics, passes)
    ...
    if evaluate:
        ...
        get_perplexity_and_coherence_score(ntopics, "nl", nl_term_matrix, nl_tweets, nl_dict, lda_nl)
...
def get_processed_lda_tweets_from_db(table, load):
    if load:
        eng_tweets_text = load_with_pickle("en_tweets_text")
...
if __name__ == '__main__':
    ...
    for f in fpoints:
        ...
        data["nlpolpoly"] = get_sent_from_polyglot(nl_tweets, "nl")
        ...
        if nl_tweets:
            nl_trans_tweets = get_text_trans_in_eng(nl_tweets)
            data["nlpolblob"], data["nlsubblob"] = get_sent_from_textblob(nl_trans_tweets)
        else:
