...
if __name__ == '__main__':
    ...
    for source in source_list:
        ...
        for lang in lang_list:
            ...
            dict = corpora.Dictionary.load(lang + "_dict_" + source + ".pkl")
            term_matrix = corpora.MmCorpus(lang + "_term_matrix_" + source + ".mm")
