...
def get_venues_by_ll(ll, radius):
...
if __name__ == '__main__':
    ...
    for venue in venues["venues"]:
        if "categories" in venue and venue["categories"]:
            ...
            #print(venue["name"], categories_dict[id_category])
            #print(vens)
        #if vens["name"] == "Καραγκιόζης":
        #   print(vens)
  ...
  #  for i in photos["photos"]["items"]:
        #print(i)
        #img_url = i['prefix'] + 'original' + i['suffix']
